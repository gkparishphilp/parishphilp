...
Devise.setup do |config|
	...
	config.mailer_sender = "no-reply@email.com"
	...
	# config.pepper = "abd8cf3b3e8dca42988912c2b3e13639059aa884fb7000d487474d3563613a0f71021efbb5c488aebe959b183ebe9090263f776374252792250a2fe30a7d85b7"
	...
	config.rememberable_options = { :secure => !Rails.env.development? }
	...
	# config.omniauth :facebook, ENV["FACEBOOK_KEY"], ENV["FACEBOOK_SECRET"], { scope: "publish_stream, email, manage_pages" }
	# config.omniauth :twitter, ENV["TWITTER_KEY"], ENV["TWITTER_SECRET"]
